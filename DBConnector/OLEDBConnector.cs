...
{
    public class OLEDBConnector : IDBConnector, IDisposable
    {
        private string _connectionString;
        private bool _activeTransaction = false;
        private IntPtr nativeResource = Marshal.AllocHGlobal(100);
        private OleDbConnection sqlcn;
        private DataTable dataTable;
        private OleDbTransaction _sqlTransactionGlobal;
        ...
        public OLEDBConnector(string connectionString)
        {
            ...
            sqlcn = new OleDbConnection(_connectionString);
        ...
        public int ExecuteQuery(string query)
        {
            ...
            OleDbCommand sqlcmd = new OleDbCommand(query, sqlcn);
            if (_activeTransaction)
            {
                sqlcmd.Transaction = _sqlTransactionGlobal;
            }
        ...
        public int ExecuteSP(string spName)
        {
            ...
            OleDbCommand sqlcmd = new OleDbCommand(querySp.ToString(), sqlcn);
        ...
        public bool ExecuteSQLTransactions()
        {
            ...
            OleDbCommand sqlcmd = new OleDbCommand();
            sqlcmd.Connection = sqlcn;
            OleDbTransaction sqlTransaction;
        ...
        public DataTable SelectQueryToDataTable(string query)
        {
            ...
            OleDbCommand sqlcmd = new OleDbCommand(query, sqlcn);
            OleDbDataAdapter sqlDataAdapter = new OleDbDataAdapter(sqlcmd);
            dataTable = new DataTable();
            try
            {
